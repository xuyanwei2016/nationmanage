...
export const asyncRouterMap = [{
    ...
    },
    {
        ...
        children: [{
            ...
            path: 'medical',
            component: _import('database/medical/index'),
            name: 'medical',
            meta: {
                title: '医论',
                routerIds: ['1521']
    ...
    },
    {
        ...
        children: [{
            ...
            },
            {
                ...
                path: 'onlinePublishing',
                component: _import('websitemanage/onlinePublishing/index'),
                ...
                hidden: true,
                path: 'onlinePublishing/see_onlinePublishing',
                component: _import('websitemanage/onlinePublishing/see_onlinePublishing'),
                name: 'see_onlinePublishing',
                meta: {
                    title: '查看在线出版',
                    routerIds: ['0316']
                }
    ...
    },
    {
        ...
        children: [{
            ...
            },
            {
                ...
                path: 'mirror',
                component: _import('database/mirror/index'),
                name: 'mirror',
                meta: {
                    title: '镜像库管理',
                    routerIds: ['0707']
    ...
    },
    {
        ...
        children: [{
                ...
                {
                    path:'resources',
                    component:_import('medicalTreatment/resources/index'),
                    name:'resoruces',
                    meta:{
                      title:'资源管理',
                      routerIds:['1804']
                  ...
                  {
                    path:'editResources',
                    component:_import('medicalTreatment/resources/editResources'),
                    name:'editResources',
                    hidden:true,
                    meta:{
                      title:'修改资源',
                ...
                {
                    path: 'linkCourse',
                    component: _import('medicalTreatment/courseManage/linkCourse'),
                    name: 'linkCourse',
                    hidden: true,
                    meta: {
                        title: '关联视频',
    ...
    },
    {
        ...
        children: [{
            ...
            component: _import('institutionalStatistics/statisticalChart/index'),
