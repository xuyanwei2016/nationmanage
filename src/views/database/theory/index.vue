  ...
  <el-container>
    ...
    <el-main>
      <div class="nav-buttons-container">
        <router-link
          :to="{ path:`create`,query:{articleType:31,articleName:'理论'}}"
      ...
      >
        ...
        >
          <template slot-scope="scope">
            <router-link
              :to="{ path:`create`, query:{id:scope.row.id,articleType:31,articleName:'理论'}}"
            ...
            <router-link
              :to="{ path:`create`, query:{detailsId:scope.row.id,articleType:31,articleName:'理论'}}"
...
export default {
  ...
  mounted() {
    ...
    this.listQuery.resourceType = 31;
    this.getList()
    this.getNav()
  },
  methods: {
    ...
    resetFilter(){//重置
      ...
      this.listQuery = {
        ...
        resourceType: 31,//文章类型 1理论 2药物 3方剂 4临床 5医案 6文化 7机构 8其他 9未分类 10蒙文
